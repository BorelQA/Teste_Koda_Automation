...
Agora que temos a base para trabalhar, vamos então a parte das [configurações](https://github.com/BorelQA/Teste_Koda_Automation/blob/master/Configuracoes.md), pois devemos montar nosso ambiente para trabalhar.
